...
***
## Stable Build
[Stable-v1.16.0](https://github.com/deadlykam/CodeOptPro_Godot/tree/Stable-v1.16.0) is the latest stable build of the project. The compressed file for this project can also be found there. If development is going to be done on this project then it is adviced to branch off of any _Stable_ branches because they will **NOT** be changed or updated except for README.md. Any other branches are subjected to change including the main branch.
***
## Installation
1. First download the latest [CodeOptPro-v1.16.0.zip](https://github.com/deadlykam/CodeOptPro_Godot/releases/tag/v1.16.0) from the latest Stable build.
